...
public class ChatGptConfig {
    ...
    public static final String MODEL = "text-davinci-003"; // gpt 모델
    public static final Integer MAX_TOKEN = 2000; // 내용 생성할 때, 토큰의 최대값
    public static final Double TEMPERATURE = 0.0; // 0~2 사이의 값으로 설정,
